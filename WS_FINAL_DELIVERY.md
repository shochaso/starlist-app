...
**変更内容**:
- `workflow_dispatch: {}` を追加（手動実行を有効化）
...
- `.github/workflows/weekly-routine.yml`: workflow_dispatch追加済み
- `.github/workflows/allowlist-sweep.yml`: workflow_dispatch追加済み
