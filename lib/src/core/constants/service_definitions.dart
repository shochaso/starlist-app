...
class ServiceDefinitions {
  ...
  static final Map<String, ServiceDefinition> _services = {
    ...
    'facebook': const ServiceDefinition(
      id: 'facebook',
      name: 'Facebook',
      category: ServiceCategory.sns,
    ...
    'niconico': const ServiceDefinition(
      id: 'niconico',
      name: 'ニコニコ動画',
      category: ServiceCategory.video,
    ...
    'furatch': const ServiceDefinition(
      id: 'furatch',
      name: 'ふわっち',
      category: ServiceCategory.streaming,
    ...
    '17live': const ServiceDefinition(
      id: '17live',
      name: '17LIVE',
      category: ServiceCategory.streaming,
    ...
    'pococha': const ServiceDefinition(
      id: 'pococha',
      name: 'Pococha',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.video,
    ...
    'netflix': const ServiceDefinition(
      id: 'netflix',
      name: 'Netflix',
      category: ServiceCategory.video,
      icon: FontAwesomeIcons.video,
      primaryColor: Color(0xFFE50914),
      secondaryColor: Color(0xFF221F1F),
      description: '映画・ドラマストリーミング',
      svgPath: 'assets/icons/services/netflix.svg',
    ),
    'prime_video': const ServiceDefinition(
      id: 'prime_video',
      name: 'Prime Video',
      category: ServiceCategory.video,
    ...
    'dtv': const ServiceDefinition(
      id: 'dtv',
      name: 'dTV',
      category: ServiceCategory.video,
      icon: FontAwesomeIcons.video,
      primaryColor: Color(0xFFEF0030),
      secondaryColor: Color(0xFFD10028),
      description: '映像配信サービス',
      svgPath: 'assets/icons/services/dtv.svg',
    ),
    'fod': const ServiceDefinition(
      id: 'fod',
      name: 'FOD',
      category: ServiceCategory.video,
      icon: FontAwesomeIcons.f,
      primaryColor: Color(0xFF111111),
      secondaryColor: Color(0xFFD0021B),
      description: 'フジテレビオンデマンド',
      svgPath: 'assets/icons/services/fod.svg',
    ),

    // 音楽
    'spotify': const ServiceDefinition(
      id: 'spotify',
      name: 'Spotify',
    ...
    'apple_music': const ServiceDefinition(
      id: 'apple_music',
      name: 'Apple Music',
      category: ServiceCategory.music,
      icon: FontAwesomeIcons.music,
      primaryColor: Color(0xFFFA2D48),
      secondaryColor: Color(0xFFFF6B35),
      description: '音楽ストリーミング',
      svgPath: 'assets/icons/services/apple_music.svg',
    ),
    'amazon_music': const ServiceDefinition(
      id: 'amazon_music',
      name: 'Amazon Music',
      category: ServiceCategory.music,
    ...
    // ショッピング
    'amazon': const ServiceDefinition(
      id: 'amazon',
      name: 'Amazon',
    ...
    'zozotown': const ServiceDefinition(
      id: 'zozotown',
      name: 'ZOZOTOWN',
      category: ServiceCategory.shopping,
    ...
    'qoo10': const ServiceDefinition(
      id: 'qoo10',
      name: 'Qoo10',
      category: ServiceCategory.shopping,
      icon: FontAwesomeIcons.shoppingBag,
      primaryColor: Color(0xFFFF6600),
      secondaryColor: Color(0xFFE55A00),
      description: '購入履歴・Qポイント',
      svgPath: 'assets/icons/services/qoo10.svg',
    ),
    'valuecommerce': const ServiceDefinition(
      id: 'valuecommerce',
      name: 'ValueCommerce',
      category: ServiceCategory.shopping,
      icon: FontAwesomeIcons.link,
      primaryColor: Color(0xFF4C4C9D),
      secondaryColor: Color(0xFF3A2F73),
      description: 'アフィリエイトASP',
      svgPath: 'assets/icons/services/valuecommerce.svg',
    ),
    'youtube_music': const ServiceDefinition(
      id: 'youtube_music',
      name: 'YouTube Music',
      category: ServiceCategory.music,
      icon: FontAwesomeIcons.music,
    ...
    'bereal': const ServiceDefinition(
      id: 'bereal',
      name: 'BeReal',
      category: ServiceCategory.sns,
    ...
    'threads': const ServiceDefinition(
      id: 'threads',
      name: 'Threads',
      category: ServiceCategory.sns,
    ...
    'linktree': const ServiceDefinition(
      id: 'linktree',
      name: 'Linktree',
      category: ServiceCategory.sns,
      icon: FontAwesomeIcons.link,
      primaryColor: Color(0xFF39e09b),
      secondaryColor: Color(0xFF2bc57a),
      description: 'リンクまとめ・プロフィール',
      svgPath: 'assets/icons/services/linktree.svg',
    ),
    'twitcasting': const ServiceDefinition(
      id: 'twitcasting',
      name: 'ツイキャス',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.video,
    ...
    'line_live': const ServiceDefinition(
      id: 'line_live',
      name: 'LINE LIVE',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.video,
    ...
    'mildom': const ServiceDefinition(
      id: 'mildom',
      name: 'Mildom',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.gamepad,
      primaryColor: Color(0xFF6441a5),
      secondaryColor: Color(0xFF4c2d7a),
      description: 'ゲーム配信・投げ銭',
      svgPath: 'assets/icons/services/mildom.svg',
    ),
    'bigolive': const ServiceDefinition(
      id: 'bigolive',
      name: 'BIGO LIVE',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.video,
      primaryColor: Color(0xFF00C9BF),
      secondaryColor: Color(0xFF00A89F),
      description: 'グローバル向けライブ配信',
      svgPath: 'assets/icons/services/bigolive.svg',
    ),
    'openrec': const ServiceDefinition(
      id: 'openrec',
      name: 'OPENREC.tv',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.gamepad,
      primaryColor: Color(0xFFFF8C3A),
      secondaryColor: Color(0xFFFF6A00),
      description: 'ゲーム実況・eスポーツ配信',
      svgPath: 'assets/icons/services/openrec.svg',
    ),
    'mirrativ': const ServiceDefinition(
      id: 'mirrativ',
      name: 'Mirrativ',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.mobileScreen,
      primaryColor: Color(0xFF26D0C9),
      secondaryColor: Color(0xFF1CB2AC),
      description: 'スマホゲーム配信',
      svgPath: 'assets/icons/services/mirrativ.svg',
    ),
    'reality': const ServiceDefinition(
      id: 'reality',
      name: 'REALITY',
      category: ServiceCategory.streaming,
    ...
    'iriam': const ServiceDefinition(
      id: 'iriam',
      name: 'IRIAM',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.cat,
      primaryColor: Color(0xFF4DC9FF),
      secondaryColor: Color(0xFF2FB7FF),
      description: 'バーチャルライバー配信',
      svgPath: 'assets/icons/services/iriam.svg',
    ),
    'spoon': const ServiceDefinition(
      id: 'spoon',
      name: 'Spoon',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.microphoneLines,
      primaryColor: Color(0xFFFF5A1C),
      secondaryColor: Color(0xFFE04304),
      description: '音声ライブ配信',
      svgPath: 'assets/icons/services/spoon.svg',
    ),
    'tangome': const ServiceDefinition(
      id: 'tangome',
      name: 'Tango',
      category: ServiceCategory.streaming,
      icon: FontAwesomeIcons.video,
      primaryColor: Color(0xFFFF477A),
      secondaryColor: Color(0xFFD63465),
      description: 'ライブ配信・ビデオ通話',
      svgPath: 'assets/icons/services/tangome.svg',
    ),
    'live_concert': const ServiceDefinition(
      id: 'live_concert',
      name: 'ライブ・コンサート',
      category: ServiceCategory.music,
    ...
    'other_ec': const ServiceDefinition(
      id: 'other_ec',
      name: 'その他EC',
      category: ServiceCategory.shopping,
      icon: FontAwesomeIcons.store,
      primaryColor: Color(0xFF5E35B1),
      secondaryColor: Color(0xFF3F1E8C),
      description: 'その他ECサイト購入履歴',
      svgPath: 'assets/icons/services/other.svg',
    ),

    // グルメ・食事
    'tabelog': const ServiceDefinition(
      id: 'tabelog',
      name: '食べログ',
    ...
    'gurunavi': const ServiceDefinition(
      id: 'gurunavi',
      name: 'ぐるなび',
      category: ServiceCategory.food,
      icon: FontAwesomeIcons.pizzaSlice,
      primaryColor: Color(0xFF00A0E9),
      secondaryColor: Color(0xFF0080C7),
      description: 'レストラン・予約',
      svgPath: 'assets/icons/services/restaurant.svg',
    ),
    'hotpepper': const ServiceDefinition(
      id: 'hotpepper',
      name: 'ホットペッパー',
      category: ServiceCategory.food,
    ...
    'ubereats': const ServiceDefinition(
      id: 'ubereats',
      name: 'Uber Eats',
      category: ServiceCategory.food,
    ...
    // 読書・学習
    'kindle': const ServiceDefinition(
      id: 'kindle',
      name: 'Kindle',
    ...
    'game_apps': const ServiceDefinition(
      id: 'game_apps',
      name: 'ゲームアプリ',
      category: ServiceCategory.entertainment,
    ...
    'books_manga': const ServiceDefinition(
      id: 'books_manga',
      name: '書籍・漫画',
      category: ServiceCategory.entertainment,
      icon: FontAwesomeIcons.book,
    ...
    'cinema': const ServiceDefinition(
      id: 'cinema',
      name: '映画館',
      category: ServiceCategory.entertainment,
    ...
    'restaurant': const ServiceDefinition(
      id: 'restaurant',
      name: 'レストラン・カフェ',
      category: ServiceCategory.food,
      icon: FontAwesomeIcons.utensils,
    ...
    'delivery': const ServiceDefinition(
      id: 'delivery',
      name: 'デリバリー',
      category: ServiceCategory.food,
      icon: FontAwesomeIcons.truck,
    ...
    'cooking': const ServiceDefinition(
      id: 'cooking',
      name: '自炊',
      category: ServiceCategory.food,
      icon: FontAwesomeIcons.fire,
    ...
    // 汎用アプリ・サービス
    'smartphone_apps': const ServiceDefinition(
      id: 'smartphone_apps',
      name: 'スマホアプリ',
      category: ServiceCategory.entertainment,
      icon: FontAwesomeIcons.mobileScreenButton,
    ...
    'web_services': const ServiceDefinition(
      id: 'web_services',
      name: 'ウェブサービス',
      category: ServiceCategory.entertainment,
    ...
    // その他
    'receipt': const ServiceDefinition(
      id: 'receipt',
      name: 'レシート',
    ...
    'pixiv': const ServiceDefinition(
      id: 'pixiv',
      name: 'pixiv',
      category: ServiceCategory.other,
      icon: FontAwesomeIcons.palette,
      primaryColor: Color(0xFF0096FA),
