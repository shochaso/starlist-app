...
* **5-2. 無料会員**  
  ...
  * **提供サービス（チケットなしで利用可能）:**  
    * **「毎日ピック from Star」:**  
      * **コンセプト: どのスターの情報かはランダムで、そのスターが過去に共有した全データ（有料プラン向けで、かつ無料公開範囲としてスターが許可したもの）の中から、システムがランダムで1つの情報をピックアップして表示。スターの更新頻度に左右されず、毎日異なる情報の断片に触れられる。**  
    * **スターの基本プロフィール閲覧。**  
