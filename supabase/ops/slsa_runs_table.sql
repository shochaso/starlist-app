-- SLSA Provenance Runs Table (Narrow-scope service key)
-- Stores provenance generation and validation results for audit and KPI
-- This file is separate from migrations for operational clarity
...
-- Only service_role with specific claims can write
...
drop trigger if exists update_slsa_runs_updated_at on public.slsa_runs;
