...
// Calculate verdict from thresholds (μ±2σ: warning, μ±3σ: fail)
...
export default function AuditDashboard() {
  ...
  // Calculate verdicts for each KPI
  const slackSuccessVerdict = stats && kpi
    ? calculateVerdict(kpi.slack_success_rate, stats.mean, stats.stdDev)
    : undefined;
  const p95LatencyVerdict = stats && kpi
    ? calculateVerdict(kpi.p95_latency_ms, stats.mean, stats.stdDev)
    : undefined;
  const checkoutSuccessVerdict = stats && kpi
    ? calculateVerdict(kpi.checkout_success_rate, stats.mean, stats.stdDev)
    : undefined;
    ...
    <div className="p-6 grid gap-6">
      ...
      {!kpi ? (
        ...
        <>
          ...
          {/* Footer with 10x enhancement pack link */}
