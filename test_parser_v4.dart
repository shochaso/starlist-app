import 'lib/src/services/youtube_ocr_parser_v4.dart';
...
マイペ''';
  ...
  final parsedVideos1 = YouTubeOCRParserV4.parseOCRText(testData1);
  ...
  final parsedVideos2 = YouTubeOCRParserV4.parseOCRText(testData2);
  ...
  if (double.parse(accuracy1) >= 90 && double.parse(accuracy2) >= 90) {
    ...
    print('   データセット1が90%未満: ${double.parse(accuracy1) < 90}');
    print('   データセット2が90%未満: ${double.parse(accuracy2) < 90}');
  }
}